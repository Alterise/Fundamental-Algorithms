    ...
    while (fgets(string_buff, BUFSIZ, fin))
    {
        for (i = 0; i < strlen(string_buff); i++)
        {
            if(string_buff[i] == ';')
            {
                ...
                if(to_do)
                {
                    if(to_do == 10) printf("Function LOAD fail (Array isn't empty) [Command № %d]\n", step_counter);
                    else if(to_do == 11) printf("Function LOAD fail (File opening error) [Command № %d]\n", step_counter);
                    else if(to_do == 12) printf("Function LOAD fail (Wrong input) [Command № %d]\n", step_counter);
                    ...
                    else if(to_do == 60) printf("Function REMOVE fail (Array is empty) [Command № %d]\n", step_counter);
                    else if(to_do == 61) printf("Function REMOVE fail (Invalid ID of start element) [Command № %d]\n", step_counter);
                    else if(to_do == 62) printf("Function REMOVE fail (Invalid ID of end element) [Command № %d]\n", step_counter);
                    else if(to_do == 70) printf("Function COPY fail (1st array is empty) [Command № %d]\n", step_counter);
                    else if(to_do == 71) printf("Function COPY fail (2st array isn't empty) [Command № %d]\n", step_counter);
                    else if(to_do == 72) printf("Function COPY fail (Invalid ID of start element) [Command № %d]\n", step_counter);
                    else if(to_do == 73) printf("Function COPY fail (Invalid ID of end element) [Command № %d]\n", step_counter);
                    else if(to_do == 80) printf("Function SORT fail (Array is empty) [Command № %d]\n", step_counter);
                    else if(to_do == 90) printf("Function PERMUTATION fail (Array is empty) [Command № %d]\n", step_counter);
                    else if(to_do == 100) printf("Function STAT fail (Array is empty) [Command № %d]\n", step_counter);
                    else if(to_do == 110) printf("Function PRINT fail (Array is empty) [Command № %d]\n", step_counter);
                    else if(to_do == 111) printf("Function PRINT fail (Invalid ID of start element) [Command № %d]\n", step_counter);
                    else if(to_do == 112) printf("Function PRINT fail (Invalid ID of end element) [Command № %d]\n", step_counter);
                    else if(to_do == 120) printf("Function PRINT_ALL fail (Array is empty) [Command № %d]\n", step_counter);
                    fclose(fin);
                    exit(to_do);
                }
            }
